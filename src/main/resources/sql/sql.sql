...
CREATE TABLE `productimage` (
  ...
  UNIQUE KEY `ProductImageURL` (`ProductImageURL`),
...
INSERT INTO `employee` VALUES ('admin',1,'Chandika','Jayaweera','admin@test.com','$2a$10$dvZZylZx8hfXS.x/JJbOUe/guK/ZskeeXuxdaCdzgWxBglQ309/um');